...
namespace bl {
    ...
    public:
        ...
        static void
        onKeyEvent(GLFWwindow *window, int key, int scancode, int action,
                   int mods);

        static void
        onMouseEvent(GLFWwindow *window, int btn, int state, int mods);
        ...
        static void
        onScroll(GLFWwindow *window, double xoffset, double yoffset);
