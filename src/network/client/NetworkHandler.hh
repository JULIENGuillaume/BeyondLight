...
namespace network {
    namespace client {
        ...
        public:
            explicit NetworkHandler(std::string const &ip = "127.0.0.1", unsigned short port = 4224);
        ...
        public:
            void addWatcher(EWatcherType type, std::string const& name, std::function<void(std::string const&)>);
